...
struct Constants {
    static let API_KEY = "1c2cd562181e2eceb29e9c185546e046"
...
class APICaller {
    ...
    func makeAPIRequest<T: Decodable>(endpoint: String, responseType: T.Type, completion: @escaping (Result<T, Error>) -> Void) {
        let url = getFullUrl(endpoint)
